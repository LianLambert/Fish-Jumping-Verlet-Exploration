...
public class fishEyeRight : MonoBehaviour
{
    [SerializeField] private GameObject fishRight;
    ...
    void Start()
    {
        ...
        fishBody = Instantiate(fishRight, transform.position, transform.rotation);
        fishBody.GetComponent<fishRight>().eye = this.gameObject;

        // launch the fish eye
        launchFish();

        // destroy the fish eye after an appropriate amount of time
    ...
    void launchFish()
    {
        ...
        launchAngle = Random.Range(-55, -60);
